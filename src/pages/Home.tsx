...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans selection:bg-[#3435E5]/30 overflow-hidden bg-white">
      {/* LEFT SIDE - BRANDING */}
      <div
        className="w-full md:w-[45%] lg:w-[50%] md:fixed md:h-screen p-10 md:p-12 lg:p-20 flex flex-col justify-between relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(52, 53, 229, 0.6) 0%, rgba(20, 20, 120, 0.7) 100%)' }} />
        {/* Decorative lines */}
