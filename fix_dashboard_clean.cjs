...
export default function Dashboard() {
  ...
  const stats = [
    { name: 'XP Earned', value: xpEarned.toString(), color: 'text-indigo-700', bg: 'bg-indigo-50' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 lg:col-span-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link to="/report-bullying" className="flex flex-col items-center justify-center p-6 bg-red-50 text-red-700 rounded-xl hover:bg-red-100 transition-colors">
